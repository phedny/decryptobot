...
class HelpCommand:Command {
    override fun execute(event: GuildMessageReceivedEvent, prefix:String) {
        ...
        event.channel.send("The game consists of up to 8 rounds. In each round, first one person in each team has to come up with hints to disguise a secret code and next the rest of the team must guess the correct code. Also, you have to guess the code of the other team.\n" +
